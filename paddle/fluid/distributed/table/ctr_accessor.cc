...
int32_t CtrDoubleUnitAccessor::select(float** select_values,
  ...
  for (size_t value_item = 0; value_item < num; ++value_item) {
    ...
    select_value[CtrDoubleUnitPullValue::show_index()] =
        (float)*(double*)(value + unit_feature_value.show_index());
    select_value[CtrDoubleUnitPullValue::click_index()] =
        (float)*(double*)(value + unit_feature_value.click_index());
...
int32_t CtrDoubleUnitAccessor::update(float** update_values,
  ...
  for (size_t value_item = 0; value_item < num; ++value_item) {
    ...
    *(double*)(update_value + unit_feature_value.show_index()) +=
        (double)push_show;
    *(double*)(update_value + unit_feature_value.click_index()) +=
        (double)push_click;
